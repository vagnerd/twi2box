...
$NotifyEmail=GetEmailUser($BoxID);
if ($NotifyEmail) {
   $CheckActive="";
} else {
...
<body>
  <div id="main">
	...
	<p>Notify with e-mail<input type="checkbox" name="notifyemail" value="1" <?php echo $CheckActive;?>></p>

	<p><input class="submit" type="submit" value="Add Filter" name="acao">
	</form>
