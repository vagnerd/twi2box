...
<body>
  <div id="main">
   ...
   <form method="post" action="mgr-hashtag.php">
	...
	foreach ($HashTags as $HashTag) {
		...
		echo "<tr><td><INPUT TYPE=\"checkbox\" NAME=\"hashtag[]\" VALUE=\"$HashTag[1]\"></td>\n";
		echo "<td>$HashTag[2]</td>\n";
		echo "<td>$HashTag[3]</td>\n";
		echo "<td>$HashTag[4]</td></tr>\n";
   ...
   <input type="submit" value="New Hashtag" name="acao">
