...
<body>
  <div id="main">
	...
	<p>#Hashtag:</p>
	<input type="text" name="hashtagname">

	<p>Auto-Reply:</p>
	<input type="text" name="autoreplytext" maxlength="140">
	...
	<p><input class="submit" type="submit" value="Add Hashtag" name="acao">
	</form>
